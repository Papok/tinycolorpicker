;(function(window, undefined) {
    ...
    function Plugin($container, options) {
        ...
        var self          = this
        ,   $track        = $container.querySelectorAll(".colorPicker_track")[0]
        ,   $color        = $container.querySelectorAll(".colorPicker_color")[0]
        ,   $colorInner   = $container.querySelectorAll(".colorPicker_colorInner")[0]
        ,   $canvas       = null
        ,   $colorInput   = $container.querySelectorAll(".colorPicker_colorInput")[0]
